...
namespace Estore.Data.Migrations
{
    ...
    [Migration("20220303163454_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Estore.Data.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("Estore.Data.Models.Cart", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Estore.Data.Models.Image", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Estore.Data.Models.Product", b =>
                {
                    ...
                    b.Property<int>("ItemApplyDiscount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Estore.Data.Models.ProductTag", b =>
                {
                    b.Property<string>("ProductId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Estore.Data.Models.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Estore.Data.Models.Tag", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Estore.Data.Models.ApplicationUser", b =>
                {
                    b.HasOne("Estore.Data.Models.Cart", "Cart")
                        .WithOne("User")
                        .HasForeignKey("Estore.Data.Models.ApplicationUser", "CartId")
            ...
            modelBuilder.Entity("Estore.Data.Models.ProductTag", b =>
                {
                    ...
                    b.HasOne("Estore.Data.Models.Tag", "Tag")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Estore.Data.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Estore.Data.Models.ApplicationUser", null)
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
